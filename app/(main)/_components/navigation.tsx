...
const Navigation = () => {
  ...
  // side bar will be collapsed by default for mobile devices
  ...
  return (
    <>
      ...
      {/* Sync with width and collapse state of sidebar */}
      <div
        ref={navbarRef}
        className={cn(
      ...
      >
        {!!params.documentId ? (<Navbar isCollapsed={isCollapsed} onResetWidth={resetWidth}/>): <nav className="bg-transparent px-3 py-2 w-full">
          {isCollapsed && (
